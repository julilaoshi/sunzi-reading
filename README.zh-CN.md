...
- 把难读的论文摘要和段落讲成普通人能听懂的话。
- 抓住研究问题、方法、结论和真正有用的证据。
- 明确作者证明了什么，也指出作者没有证明什么。
- 拆开吓人的术语，同时保留必要的学术准确性。
- 用短、准、有人味的方式降低第一次读论文的压力。

## 这个仓库为什么存在

很多读者不是没有理解能力，而是先被论文的写法和术语挡住了。

这个仓库公开一套短、准、有人味的解释方法，让初学者先抓住研究主干，再决定是否深入原文。
